...
// [DEMO] All four payment methods share the same static QR image.
...
export default function PaymentPage({ params }: { params: Promise<{ orderId: string }> }) {
  ...
  // Load the server-calculated order countdown.
  useEffect(() => {
  ...
  // [DEMO] Mark the order as paid through the simulated callback.
  // The success view redirects to order lookup, where delivery is triggered.
  ...
  return (
    <div className="mx-auto flex max-w-lg flex-col items-center gap-6 py-8">
      ...
      <div className="flex w-full flex-col items-center gap-4 rounded-xl border border-border bg-card p-6 shadow-sm">
        ...
        {isUsdtPayment ? (
          ...
          <div className="flex w-full flex-col items-center gap-3">
            ...
            >
              {/* [DEMO] The QR image directs users to the simulated payment button. */}
          ...
          /* Desktop and mobile share the demo QR view. */
          <>
            <div
      ...
      {/* [DEMO] Simulated payment action using the current theme color. */}
      <button
